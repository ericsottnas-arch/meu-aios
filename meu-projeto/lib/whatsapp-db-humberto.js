// meu-projeto/lib/whatsapp-db-humberto.js
// Banco: Dr. Humberto (instância smv2-7)

const Database = require('better-sqlite3');
const path = require('path');
const fs = require('fs');

const DB_PATH = path.resolve(__dirname, '../../../docs/clientes/dr-humberto/banco-dados/conversas.db');
let db = null;
...
function initDB() {
  ...
  console.log(`✅ Dr. Humberto DB inicializado`);
}
...
function saveMessage(parsed) {
  ...
  try {
    ...
    console.error(`Erro ao salvar no DB Humberto:`, err);
  }
}
