// meu-projeto/lib/whatsapp-db-torre1.js
// Banco separado: Torre 1

const Database = require('better-sqlite3');
const path = require('path');
const fs = require('fs');

const DB_PATH = path.resolve(__dirname, '../../../docs/clientes/torre-1/banco-dados/conversas.db');
let db = null;
...
function initDB() {
  ...
  console.log(`✅ Torre 1 DB inicializado em ${DB_PATH}`);
}
...
function saveMessage(parsed) {
  ...
  try {
    ...
    console.log(`   [DB-TORRE1] Inserido: ${result.changes} linhas`);
  } catch (err) {
    console.error(`   [DB-TORRE1] ❌ Erro ao salvar:`, err.message);
  }
}
