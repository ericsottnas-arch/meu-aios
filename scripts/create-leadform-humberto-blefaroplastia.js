/**
 * Cria Formulário Nativo — Blefaroplastia — Dr. Humberto Andrade
 * Página: 104425248310435
 *
 * Formulário exclusivo para blefaroplastia.
...
const FORM = {
  name: '[Syra] Dr. Humberto — Blefaroplastia Paciente Modelo - Maio v2',
  ...
  questions: [
    ...
    },
    {
      ...
      label:   'Qual sua disponibilidade em Maio?',
      options: [
        { key: 'comeco_maio',        value: 'Começo de Maio — estou pronta' },
        { key: 'segunda_metade',     value: 'Segunda metade de Maio funciona melhor' },
        { key: 'qualquer_semana',    value: 'Tenho flexibilidade, qualquer semana' },
        { key: 'ainda_nao_sei',      value: 'Ainda preciso ver minha agenda' },
      ],
    },
    { type: 'FULL_NAME' },
    { type: 'PHONE' },
  ...
  context_card: {
    style:   'LIST_STYLE',
    title:   'Avaliação para Blefaroplastia com Dr. Humberto Andrade',
    content: [
...
async function main() {
  console.log('===========================================');
  console.log('  Formulário Blefaroplastia — DR. HUMBERTO');
  console.log('  Formulário exclusivo — Blefaroplastia');
  ...
  console.log('  → Vincular no conjunto de anúncios de blefaroplastia');
